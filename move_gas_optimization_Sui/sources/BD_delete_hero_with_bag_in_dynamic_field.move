module move_gas_optimization::BD_delete_hero_with_bag_in_dynamic_field{
    ...
    public entry fun delete_hero_with_bag_in_dynamic_fields_detach_and_delete_children(mut hero: Hero){
        //1) Call delete_bag_contents
        delete_bag_contents(&mut hero);
        //2) Unpack and delete Bag
        bag::destroy_empty(dynamic_field::remove(&mut hero.id, b"bag"));
